<template>
  <v-container>
    <v-row align="center" justify="center" style="min-height: 80vh;">
      ...
      >
        <h2 class="display-md-1 font-weight-bold">
          {{ $t('home.pretitle') }}
        </h2>
        <h1 class="display-1 display-md-3 font-weight-bold">
          TwitchBuddy
        </h1>
              ...
              <v-card-actions class="text-center">
                ...
                >
                  <template v-if="item.badge" v-slot:badge>
                    <span class="px-1 badge">{{ item.badge }}</span>
                  </template>
                  <v-btn
                    :to="item.link"
                    nuxt
      ...
      items: [
        {
          ...
          content: this.$t('home.clips'),
          link: this.$i18n.path('clips'),
          badge: false
        },
        {
          title: 'Replay sync',
